    ...
    const testimonials = [
        {
          ...
          name: "Nattasha Mith",
          location: "Sydney, USA",
          quote: "Lorem Ipsum is simply dummy text of the typesetting industry.Lorem Ipsum is simply dummy text of the typesetting industry...",
        },
        {
          image: "https://i.pngimg.me/thumb/f/720/m2i8d3i8N4d3N4K9.jpg",
          name: "John Doe",
          location: "New York, USA",
          quote: "Another great quote about your service goes here.Another great quote about your service goes here...",
        },
        {
          image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuLEziy2FWAM6Z0NT0yTmsmD2VySobPG4y7eWSEd4heKgu-cU0WCZLxn5Poox0Y9KYmyc&usqp=CAU",
          name: "Jane Smith",
          location: "London, UK",
          quote: "Your product was a game-changer for me!Your product was a game-changer for me!.Your product was a game-changer for me!",
        },
      ];
  return (
    <div className='w-[1200px] h-[550px] bg-slate-300 rounded-3xl flex flex-col items-center justify-center mt-28 gap-10'>
        <p className=" text-gray-800 text-center font-serif text-5xl font-normal leading-125 tracking-wide">What People Thinks About Us!</p>

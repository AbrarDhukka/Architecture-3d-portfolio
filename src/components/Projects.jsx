    ...
    <div className="flex flex-wrap w-[1200px] gap-8 justify-between items-center mt-16">
      ...
      <div className="w-[46%] h-[550px] bg-slate-100 rounded-3xl">
        ...
        <div className="bg-slate-700 text-white -mt-28 flex items-center flex-col">
          <p className="z-30 font-serif font-bold text-2xl">
            Modern luxury villa house building
          </p>
          <a
            className="cursor-pointer z-30 hover:underline"
            target="_blank"
            rel="noreferrer"
            href="https://sketchfab.com/3d-models/modern-luxury-villa-house-building-2a07a4a90ae54dd6bba3e33862b266ef"
          >
            Source - Sketchfab
          </a>
          <a
      ...
      <div className="w-[46%] h-[550px] bg-black rounded-3xl">
        ...
        <div className="bg-slate-700 text-white -mt-28 flex items-center flex-col">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            href="https://sketchfab.com/3d-models/cozy-modern-living-room-6a030bdb839e4e74bb58d7edb8f329e7"
          >
            Source - Sketchfab
          </a>
          <a
            className="z-30 hover:underline"
            href="https://sketchfab.com/dylanheyes"
            target="_blank"
            rel="noreferrer"
          >
            Author - Dylanheyes
      ...
      <div className="w-[46%] h-[550px] bg-black rounded-3xl">
        ...
        <div className="bg-slate-700 text-white -mt-28 flex items-center flex-col">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            href="https://sketchfab.com/3d-models/beach-restaurant-4c249b79c79d41e697fa7e4e0a895007"
          >
            Source - Sketchfab
          </a>
          <a
            className="z-30 hover:underline"
            href="https://sketchfab.com/AndresMora1"
            target="_blank"
            rel="noreferrer"
          >
            Author - AndresMoral

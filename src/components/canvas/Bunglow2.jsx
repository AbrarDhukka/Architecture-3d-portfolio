  ...
  return (
    ...
    style={{ width: "550px", height: "550px" }}
      ...
      <Suspense fallback={null}>
        ...
        <BunglowModel position={[0.5,0.5,0.5]} rotation={[0, Math.PI*2, 0]}/>
      </Suspense>
    </Canvas>
    </div>
  );
